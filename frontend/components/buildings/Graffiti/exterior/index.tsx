...
import { skylineTowersExteriorConfig } from '../../Skyline towers/exterior/config';
...
export default function GraffitiExterior({ visible, onClose, modelUrl, propertyName, onEnterInterior }: GraffitiExteriorProps) {
  const [loading, setLoading] = useState(true);

  React.useEffect(() => {
    if (visible) {
      console.log(`[FILE EXECUTING: frontend/components/buildings/Graffiti/exterior/index.tsx] Component mounted for: ${propertyName}`);
    }
